...
import { formatKc, isBulky } from "@/data/catalog";
    ...
    <div className="group flex flex-col bg-paper">
      ...
      <div className="flex flex-1 flex-col pt-4">
        ...
        <div className="mt-auto flex flex-col items-start gap-3 pt-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <button disabled={out} onClick={() => add({ slug: p.slug, name: p.name, brand: p.brand, price: p.price, image: img, bulky: isBulky(p.category) })}
