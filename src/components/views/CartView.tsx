    ...
    <section className="container-x py-12">
      ...
      {hydrated && items.length === 0 ? (
        <div className="mt-10 border-t hairline py-16 text-center">
          ...
          <Link href="/male-spotrebice/" className="btn-ink mt-6">{t(c.continue)}</Link>
        </div>
      ) : (
        <div className="mt-10 grid gap-12 lg:grid-cols-[7fr_4fr]">
          ...
          <aside className="h-fit bg-tile p-6">
            ...
            <Link href="/male-spotrebice/" className="btn-link mt-5 block text-center">{t(c.continue)}</Link>
