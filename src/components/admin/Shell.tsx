    ...
    <ToastProvider>
      <div className="min-h-screen bg-[#f6f6f4] text-ink">
        <header className="sticky top-0 z-30 flex h-14 items-center gap-4 border-b border-hair bg-paper px-4">
          ...
          <Link href="/admin/" className="text-[15px] font-extrabold uppercase tracking-[-0.03em]">Elektro Dvořák <span className="ml-1 rounded bg-tile px-1.5 py-0.5 text-[10px] font-semibold tracking-normal text-mute">ADMIN</span></Link>
