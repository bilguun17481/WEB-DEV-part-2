...
export interface ShippingMethod {
  ...
  enabled: boolean; needs_pickup_point: boolean; bulky: boolean; sort: number;
}
...
export interface OrderItem { slug: string; name: string; brand?: string; price: number; qty: number; image?: string; bulky?: boolean }
