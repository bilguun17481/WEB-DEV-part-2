...
const blankSection = (type: Section["type"]): Section => {
  ...
  switch (type) {
    ...
    case "categories": return { id: uid(), type, eyebrow: T, title: T, text: T, categories: ["televize-audio", "velke-spotrebice", "male-spotrebice", "pocitace-telefony", "naradi", "zahrada"] };
    case "products": return { id: uid(), type, eyebrow: T, title: { cs: "Vybrané produkty", en: "Featured" }, source: "featured", limit: 8 };
